...
git push "https://$username:$password@github.com/carlosthe19916/oauth2-manager.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/carlosthe19916/oauth2-manager.git" --tags
